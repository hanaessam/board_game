    ...
    if player == AI_1:
        ...
        if maximizingPlayer:
            ...
            for col in valid_locations:
                ...
                new_score = minimax_alpha_beta(b_copy, depth - 1, alpha, beta, False, player)[1]
                if new_score > value:
                    value = new_score
                    column = col
            ...
            for col in valid_locations:
                ...
                new_score = minimax_alpha_beta(b_copy, depth - 1, alpha, beta, True, player)[1]
                if new_score < value:
                    value = new_score
                    column = col
                beta = min(beta, value)
...
pygame.display.set_caption('Connect 4 (AlphaBeta)')
